      ...
      $("#checkAll").prop("checked", false);
            ...
            $(function () {
                ...
                function resize_height(day_div_children_length) {
                  ...
                  const calendar_content = $('.day_div_content[data-day="2024-10-01"],.day_div_content[data-day="2024-10-07"],.day_div_content[data-day="2024-10-18"] ,.day_div_content[data-day="2024-10-21"]');
                  let inspection_places = 
                  `
                  
                  <div class="store_inspection ps-2 mb-2 d-flex">
