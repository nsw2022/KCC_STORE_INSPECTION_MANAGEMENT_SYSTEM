...
// ROW 데이타 정의
const rowData = [
    { No: 1, productName: "소보로빵", brand: "KCC베이커리", expiration_daynum: "30", product_price: "1800", product_sell_status: "판매중"},
    { No: 2, productName: "크림빵", brand: "KCC베이커리", expiration_daynum: "21", product_price: "2000", product_sell_status: "판매중"},
    { No: 3, productName: "소금빵", brand: "KCC베이커리", expiration_daynum: "15", product_price: "2200", product_sell_status: "판매중"},
    { No: 4, productName: "카스테라", brand: "KCC베이커리", expiration_daynum: "45", product_price: "2500", product_sell_status: "판매중"},
    { No: 5, productName: "두바이 초콜릿 쿠키", brand: "KCC베이커리", expiration_daynum: "7", product_price: "4000", product_sell_status: "품절(재고없음)"},
];
...
const gridOptions = {
    ...
    columnDefs: [// 컬럼 정의
        ...
        { field: "action", headerName: "관리", width: 110, minWidth:60, pinned: 'right',cellRenderer: BtnCellRenderer, autoHeight: true},
    ],
...
function updateCellValues() {
    // 소비기한 뒤에 '일' 추가
    const elements5n = document.querySelectorAll('.ag-cell-value.ag-cell:nth-child(5n)');
    elements5n.forEach(function(element) {
        element.innerHTML += '일';
    });

    // 가격 뒤에 '원' 붙여주고 세자리마다 ',' 추가
    const elements6n = document.querySelectorAll('.ag-cell-value.ag-cell:nth-child(6n)');
