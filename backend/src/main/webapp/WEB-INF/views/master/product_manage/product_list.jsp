...
<body>
					...
					<div class="middle-content p-5">
						<div class="header_area mb-5 d-flex align-items-center justify-content-between row mx-0">
							...
							<div class="header_btn_area d-flex align-items-center justify-content-end p-0 col-4">
								<button type="button" class="btn btn-light me-3 d-flex justify-content-center align-items-center p-0" onclick="onAddRow()">추가</button>
								<button type="button" class="btn btn-light d-flex justify-content-center align-items-center p-0" onclick="onDeleteRow()">삭제</button>
							</div>
						</div>
 ...
 <!-- 제품 등록/수정 Modal -->
 <div class="modal fade" id="productManagementModal" tabindex="-1" data-bs-keyboard="false" aria-labelledby="productManagementModalLabel" aria-hidden="true" data-bs-backdrop="static">
      ...
      <div class="modal-body">
				...
				<div class="productStatus_checkbox_area d-flex row">
					...
					<div class="radio_input_area">
						<label for="for_sale">판매중</label><input type="radio" name="pdtSellSttsCd" class="ms-1 me-3" id="for_sale">
						<label for="out_of_stack">품절</label><input type="radio" name="pdtSellSttsCd" class="ms-1 me-3" id="out_of_stack">
						<label for="pre_order">예약 판매</label><input type="radio" name="pdtSellSttsCd" class="ms-1 me-3" id="pre_order">
						<label for="not_for_sale">판매 중지</label><input type="radio" name="pdtSellSttsCd" class="ms-1 me-3" id="not_for_sale">
						<label for="restock_in_progress">재고확보중</label><input type="radio" name="pdtSellSttsCd" class="ms-1 me-3" id="restock_in_progress">
					</div>
				</div>
      </div>
