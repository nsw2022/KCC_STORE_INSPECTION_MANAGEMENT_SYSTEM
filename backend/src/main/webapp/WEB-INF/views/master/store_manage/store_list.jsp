        ...
        <div class="content">
            ...
            >
                <div class="top-box-content my-4">
                    ...
                    <%-- 자동 완성 영역 --%>
                    <div class="row g-0 align-items-center pt-4 ms-3 text-lg-center top-search-box">
                        <!-- 가맹점 라벨 -->
                        <div class="col-lg-1 col-12">
                            <label for="storeSearch" class="form-label">가맹점</label>
                        </div>
                        <!-- 가맹점 검색 필드 -->
                        <div class="col-lg-3 col-12 mb-3 mb-md-0 wrapper" data-autocomplete="store">
                        ...
                        <!-- 점검자 검색 필드 -->
                        <div class="col-lg-3 col-12 mb-3 mb-md-0 wrapper" data-autocomplete="inspector">
                            <div class="search-btn top-search form-control">
                                <span>점검자 선택</span>
                                <i class="uil uil-angle-down"></i>
                            </div>
