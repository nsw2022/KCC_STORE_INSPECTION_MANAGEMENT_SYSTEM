...
<body>
				...
				<div
					...
					<form class="input_area" action="/loginprocess" method="post">
						...
						<div class="empno_area d-flex border mb-2 align-items-center">
							<i class="fa-regular fa-lg fa-envelope mx-2" style="color: #c4c9ed;"></i>
							<input type="text" name="mbrNo" class="empno_input" placeholder="사번" autocomplete="username">
						</div>
						<div class="password_area d-flex border align-items-center">
							<i class="bi bi-shield fa-lg mx-2" style="color: #c4c9ed;"></i>
							<input type="password" name="mbrPw" class="password_input" placeholder="비밀번호" autocomplete="current-password">
							<i class="fa-regular fa-lg fa-eye-slash mx-4" style="color: #c4c9ed;"></i>
						</div>
						<div class="extra_area mt-3 d-flex align-items-center">
							<input type="checkbox" class="me-2 remember-checkbox">
	...
	<script defer
			...
			src="../../../../resources/js/home/login/login.js"
	></script>
</body>
</html>
